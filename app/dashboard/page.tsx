                        ...
                        <div className="flex items-center justify-between mb-4">
                            ...
                            {aiStatus === 'not_set' ? (
                                <div className="flex-1 flex flex-col items-center justify-center py-6 text-center">
                                    ...
                                    <Link href="/orders/repeat" className="bg-slate-100 px-4 py-2 rounded-xl text-[10px] font-black hover:bg-slate-200 transition-all uppercase tracking-widest">Detail di Repeat Orders</Link>
                                </div>
                            ) : aiStatus === 'running' ? (
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center py-10 text-center">
                                    ...
                                    <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mb-3 leading-relaxed px-4">Analisis AI hari ini belum tersedia di ringkasan</p>
                                    <Link
                                        href="/orders/repeat"
